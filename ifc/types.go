...
// String returns the human-readable name of the sensitivity level. Used by
// audit log entries and IFC block reasons so messages are readable instead
// of opaque integer codes.
