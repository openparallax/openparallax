...
#    or: sh install.sh [--version v0.1.0] [--dir ~/.local/bin]
set -e
...
ARCHIVE="openparallax_${VERSION_NUM}_${OS}_${ARCH}.tar.gz"
URL="https://github.com/${REPO}/releases/download/${VERSION}/${ARCHIVE}"
CHECKSUM_URL="https://github.com/${REPO}/releases/download/${VERSION}/checksums.txt"

echo "Installing OpenParallax ${VERSION} (${OS}/${ARCH})"
...
# Install.
mkdir -p "$INSTALL_DIR"
cp openparallax "$INSTALL_DIR/openparallax"
chmod +x "$INSTALL_DIR/openparallax"

echo ""
echo "OpenParallax ${VERSION} installed to ${INSTALL_DIR}/openparallax"
