...
- Update both `internal/templates/files/security/shield/default.yaml` and `internal/templates/files/security/shield/strict.yaml` (strict ⊇ default invariant enforced by `TestLoadStrictPolicy`)
