...
interface ShieldOptions {
  /** Path to the YAML policy file. Default: "policies/default.yaml" */
  policyFile?: string
...
const shield = new Shield({ policyFile: 'policies/default.yaml' })
...
const shield = new Shield({
  policyFile: 'policies/strict.yaml',
