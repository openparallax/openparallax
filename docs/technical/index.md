---
description: Deep dive into the OpenParallax three-process architecture — Engine, Agent, and Process Manager — and how they enforce thinking/acting separation.
---
...
| [IFC](/security/ifc) | Information flow control | Data classification and taint tracking |
