...
func writeConfig(path, workspace, agentName, avatar string,
	...
	cfg := &types.AgentConfig{
		Workspace: workspace,
		Identity:  types.IdentityConfig{Name: agentName, Avatar: avatar},
		Roles:     types.RolesConfig{Chat: "chat", SubAgent: "chat"},
		...
		Tools:   types.ToolsConfig{DisabledGroups: []string{"canvas"}},
