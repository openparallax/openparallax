...
func TestCompactUnderBudget(t *testing.T) {
	...
	result, err := c.Compact(context.Background(), messages, 10000, 0)
	require.NoError(t, err)
...
func TestCompactOverBudget(t *testing.T) {
	...
	result, err := c.Compact(context.Background(), messages, 100, 0)
	require.NoError(t, err)
...
func TestCompactPreservesRecent(t *testing.T) {
	...
	result, err := c.Compact(context.Background(), messages, 50, 0)
	require.NoError(t, err)
