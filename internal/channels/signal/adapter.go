...
// RequestApproval sends a Tier 3 approval prompt via Signal. Signal does not
// support inline buttons, so the message includes text instructions to reply
