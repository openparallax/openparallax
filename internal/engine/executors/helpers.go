...
// firstNonEmptyString returns the value of the first key in payload that
// resolves to a non-empty string. Used by tool executors that want to
// accept multiple synonymous parameter names (e.g. "archive" / "path" /
// "source") because real LLMs frequently guess the natural alternative
// rather than the schema-documented canonical name.
